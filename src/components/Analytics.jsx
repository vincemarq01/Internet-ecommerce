		...
		<div className="w-full bg-white py-16 px-4">
			<div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
				...
				<div className="flex flex-col justify-center">
					<p className="text-[#00df9a] font-bold">GROWING INTERNET SO FAST!</p>
					...
					<button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 hover:bg-gray-600 text-black">Get Started</button>
				</div>
			</div>
		</div>
	);
